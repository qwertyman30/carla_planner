...
class PathOptimizer:
    ...
    def optimize_spiral(self, xf, yf, tf):
        ...
        # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
        # ------------------------------------------------------------------
        res = optimize.minimize(fun=self.objective, x0=p0, method="L-BFGS-B", bounds=bounds,
    ...
    def sample_spiral(self, p):
        ...
        x_points = integrate.cumtrapz(np.cos(t_points), s_points)
        y_points = integrate.cumtrapz(np.sin(t_points), s_points)
